...
### 🔧 AS 키워드 감지 시 → as_agent 호출
**키워드**: "AS 요청", "AS 신청", "하자 신고", "수리 요청", "AS 접수", "고장", "문제", "수리", "AS", "애프터서비스"
**처리 방법**: 즉시 as_agent에게 질문 전달
...
''',
    ...
    description="Firebase, Email, AS 전문 에이전트들을 관리하는 라우팅 전담 메인 에이전트"
)
